...
Пример метода \_\_str\_\_ для класса [Character](https://github.com/DarkValkier/C20265/blob/master/Lesson_2/character.py#L14):
```python
def __str__(self):
        return \
            f' === {self.name} ===\n' \
...
Для каждой ошибки в методе `change_state` создать отдельный класс, унаследованный от класса Exception (аналогично классу [NotEnoughFuel](https://github.com/DarkValkier/C20265/blob/master/Lesson_4/car.py#L1) из [четвёртого урока](https://github.com/DarkValkier/C20265/blob/master/Lesson_4/)).
